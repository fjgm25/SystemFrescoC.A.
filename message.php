...
$conn = mysqli_connect("localhost", "root", "", "restaurant") or die("Database Error");
...
if (mysqli_num_rows($run_query) > 0) {
    ...
    echo "¡Lo siento, no puedo ayudarte con este inconveniente! Favor comunícate con nuestro personal ";
}
