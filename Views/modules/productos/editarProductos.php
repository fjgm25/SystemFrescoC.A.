    ...
    <input type="hidden" name="idproducto" value="<?php echo $key['idproducto']; ?>">
          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
                ...
                <input type="text" class="form-control" onblur="soloMayusculas('nombreproducto')" id="recipient-name" name="nombreproducto" value="<?php echo $key['nombreproducto'] ?>">
              </div>
            </div>
               <div class="col-md-6">  
             <div class="form-group">
      ...
      <select class="form-control chosen-select" id="idcategoria" name="idcategoria">     
           <option value="<?php echo $key['idcategoria'] ?>" ><?php echo ucwords($key['nombrecategoria']) ?>
              ...
              <?php   $cons = $conexion->query("SELECT * FROM categorias WHERE estado=1 "); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
            <div class="form-group">
              <label for="recipient-name" class="form-control-label">Precio Producto USD:</label>
              <input type="text" class="form-control" id="recipient-name" name="precioUSD" required="" value="<?php echo $key['precioUSD']   ?>">
            </div>
            </div>       
         ...
         <CENTER>
            <button type="submit" class="btn btn-primary" name="editarProductos">Actualizar Productos</button>
         </CENTER>
         <br>
       </form>
 <?php endforeach ?>
