...
<?php 
   ...
   if (isset($_POST['reporteVenta'])) {
    ...
    $sql = $conexion->prepare('SELECT c.nombrecategoria, SUM(o.total) AS "TOTAL" FROM ordenes AS o 
 ...
 ?>
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active"><i class="fa fa-list"> </i> VENTAS POR CATEGORIA CONSOLIDADO</li>
   </ol>
<!-- Nav tabs -->
            ...
            <div class="col-md-8">
               <table class="table table-bordered">
                 ...
                 <?php foreach ($respuesta as $key ): ?>             
                    ...
                    <?php endforeach ?>
                   <button class="btn btn-info" onclick="return ImprimirVentasCC(<?php echo "'".$fechaInicial."'"; ?>,<?php echo "'".$fechaFinal."'"; ?>)">IMPRIMIR</button><br><br>
                 <?php //endforeach ?>
             <?php endif ; ?>
                </table>
           </div>
