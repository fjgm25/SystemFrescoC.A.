...
<?php 
   ...
   if (isset($_POST['reporteVenta'])) {
    ...
    $sql = $conexion->prepare('SELECT o.fecha, c.nombrecategoria, SUM(o.total) AS "TOTAL" FROM ordenes AS o 
 ...
 ?>
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active"><i class="fa fa-list"> </i> VENTAS POR CATEGORIA</li>
   </ol>
<!-- Nav tabs -->
               ...
               <table class="table table-bordered">
                 ...
                 <?php foreach ($respuesta as $key ): ?>             
                    <tbody>
                         ...
                         <td class="reportes" align="center"> <?php echo "  " . $key['nombrecategoria'] ?>  </td>
                          <td class="reportes" align="center"><i class="fa fa-usd"> </i> <?php echo "  " . $key['TOTAL'] ?>  </td>
                    </tbody>
                    <?php endforeach ?>
                   <button class="btn btn-info" onclick="return ImprimirVentasC(<?php echo "'".$fechaInicial."'"; ?>,<?php echo "'".$fechaFinal."'"; ?>)">IMPRIMIR</button><br><br>
                 <?php //endforeach ?>
             <?php endif ; ?>
                </table>
           </div>
