            ...
            <div class="col-md-12">  
              <div class="form-group">
               <center> <label for="categoria-name" class="form-control-label">Nombre Categoria :</center></label>       
                <input type="text" class="form-control" id="categoria-name" name="nombrecategoria" onkeypress="return SoloLetras(event)" onblur="soloMayusculasN('nombrecategoria')" required="">
              </div>
            </div>
          </div>
