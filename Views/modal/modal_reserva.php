          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="recipient-name" name="nombrecliente" onkeypress="return SoloLetras(event)" onblur="soloMayusculasN('nombrecliente')" required="">
              </div>
            </div>
               <div class="col-md-6">  
             <div class="form-group">
              <label for="recipient-name" class="form-control-label">Cantidad de Personas:</label>
              <input type="text" class="form-control" id="recipient-name" name="cantidadpersonas" onkeypress="return SoloNumeros(event)" required="">
            </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6"> 
             <div class="form-group">
              ...
              <input type="text" class="form-control" id="recipient-name" name="telefono" onkeypress="return SoloNumeros(event)" required="">
            </div>
            </div>
            <div class="col-md-6"> 
             <div class="form-group">
