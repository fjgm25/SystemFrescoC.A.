...
<div>Tel: 0424-7111524 / 0414-7114403 / 0275-4156485</div>
<div>Email:frescoesmejor@gmail.com</div>
      ...
      <div style='margin:auto; width:100%; position:relative; padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 75px; margin-right: auto;margin-left: auto;'>
        <div style='margin:auto; max-width:900px; border:0.5px #000 solid; min-height:20px; border-radius:5px;  padding-left:10px; padding-right:10px; margin-top:20px; margin-bottom:20px;'>
          <h1 align='center'style='font-size:26px; font-weight:bold; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; color:#531063;'>Reporte Historico de Platillos</h1>
        <hr>
        ...
        <table style='font-size: 13px; margin: 10px 5px 20px 5px; text-align: left;
          ...
          <tr style='width:150px; padding: 6px; border: 1px solid #ccc; text-align:center;
            ...
            <td style='width:50px;'>PRECIO USD</td>
            <td style='width:100px;'>CATEGORIA</td>
            <td style='width:100px;'>FECHA</td>
            <td style='width:100px;'>HORA</td>
          </tr>";
          $q='SELECT * FROM productos_respaldo AS p INNER JOIN categorias AS cat ON p.idcategoria=cat.idcategoria';
...
$codigoHTML.='
      <tr style="width:150px; padding: 6px; border: 1px solid #ccc; text-align: center;
        ...
        <td style="padding: 4px">'.$dato['precio'].'</td>
        <td style="padding: 4px">'.$dato['precioUSD'].'</td>
        <td style="padding: 4px">'.$dato['nombrecategoria'].'</td>
        <td style="padding: 4px">'.$dato['fecha'].'</td>
        <td style="padding: 4px">'.$dato['hora'].'</td>
      </tr>';
      } 
 $codigoHTML.='
    </table>
    ...
    $dompdf->stream("Historico de Platillos - ".date('Y-m-d H:i:s'),array("Attachment"=>1));
