      ...
      <div style='margin:auto; width:100%; position:relative; padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 75px; margin-right: auto;margin-left: auto;'>
        ...
        <table style='font-size: 13px; margin: 10px 5px 20px 5px; text-align: left;
          ...
          <tr style='width:150px; padding: 6px; border: 1px solid #ccc; text-align:center;
            ...
            <td style='width:150px;'>NOMBRE DE CLIENTE</td>
            <td style='width:40px;'>DIA</td>
            <td style='width:40px;'>HORA</td>
            <td style='width:20px;'>CANTIDAD</td>
            <td style='width:30px;'>TELEFONO</td>
            <td style='width:200px;'>OBSERVACIONES</td>
          </tr>";
          $q='SELECT * FROM reservas WHERE estado=1';
...
$codigoHTML.='
      <tr style="width:150px; padding: 6px; border: 1px solid #ccc; text-align: center;
        ...
        <td style="padding: 4px">'.$dato['idreserva'].'</td>
        <td style="padding: 4px">'.$dato['nombrecliente'].'</td>
        <td style="padding: 4px">'.$dato['diallegada'].'</td>
        <td style="padding: 4px">'.$dato['horallegada'].'</td>
        <td style="padding: 4px">'.$dato['cantidadpersonas'].'</td>
        <td style="padding: 4px">'.$dato['telefono'].'</td>
        <td style="padding: 4px">'.$dato['observaciones'].'</td>
      </tr>';
      } 
 $codigoHTML.='
    </table>
    ...
    $dompdf->stream("Reservas - ".date('Y-m-d H:i:s'),array("Attachment"=>1));
